...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#FA8072] text-white hover:bg-[#FF6B6B] shadow-md hover:shadow-lg transform hover:scale-105",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-md hover:shadow-lg",
        outline:
          "border-2 border-[#FA8072] bg-background text-[#FA8072] hover:bg-[#FFF5F5] hover:border-[#FF6B6B]",
        secondary:
          "bg-[#FFF5F5] text-[#FA8072] hover:bg-[#FFE4E1] shadow-sm hover:shadow-md",
        ghost: "text-gray-600 hover:text-[#FA8072] hover:bg-[#FFF5F5]",
        link: "text-[#FA8072] underline-offset-4 hover:underline hover:text-[#FF6B6B]",
      },
      size: {
