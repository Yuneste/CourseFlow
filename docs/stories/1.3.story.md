...
## Tasks / Subtasks
- [ ] Create database migration for files table (AC: 6)
  - [ ] Define files table schema based on data model
  - [ ] Add file_hash column for duplicate detection
  - [ ] Add upload_source column (web, mobile, api)
  - [ ] Add is_academic_content boolean with default true
  - [ ] Set up Row Level Security policies
  - [ ] Create indexes for user_id, course_id, and file_hash
  - [ ] Test database migration
- [ ] Set up Supabase Storage bucket (AC: 5)
  - [ ] Create 'user-files' bucket in Supabase dashboard
  - [ ] Configure storage policies for authenticated users
  - [ ] Set file size limits (50MB for MVP)
  - [ ] Configure allowed MIME types
  - [ ] Enable resumable uploads
  - [ ] Set up CORS for TUS protocol support
- [ ] Create file upload API endpoint (AC: 5, 6, 7, 8, 9, 12)
  - [ ] Implement POST /api/files/upload route
  - [ ] Add authentication middleware
  - [ ] Validate file types and sizes server-side
  - [ ] Implement magic bytes validation for file content
  - [ ] Check file hash against existing uploads
  - [ ] Handle multipart form data for file uploads
  - [ ] Save file metadata to database
  - [ ] Generate unique storage paths per user
  - [ ] Implement rate limiting by file type
  - [ ] Add CSP headers for upload endpoints
  - [ ] Return upload results with file metadata
  - [ ] Track upload metrics (success/failure rates)
  - [ ] Implement proper error handling
- [ ] Build file validation utilities (AC: 7, 8, 9, 12)
  - [ ] Create lib/utils/file-validation.ts
  - [ ] Define allowed MIME types constant
  - [ ] Implement file type validation function
  - [ ] Implement magic bytes validation
  - [ ] Implement file size validation function
  - [ ] Add SHA-256 hash calculation
  - [ ] Create academic content detection for images
  - [ ] Add helper for human-readable file sizes
  - [ ] Implement image optimization utilities
- [ ] Create FileUpload component (AC: 1, 3)
  - [ ] Create components/features/files/FileUpload.tsx
  - [ ] Implement drag-and-drop zone using HTML5 APIs
  ...
  - [ ] Add fallback for non-drag-drop browsers
- [ ] Implement folder selection support (AC: 2)
  - [ ] Add folder selection button
  - [ ] Use webkitdirectory attribute for folder input
  - [ ] Handle directory traversal client-side
  - [ ] Maintain folder structure in metadata
- [ ] Create upload progress tracking (AC: 4)
  - [ ] Create components/features/files/UploadProgress.tsx
  - [ ] Implement progress bar component
  - [ ] Track individual file upload progress
  - [ ] Show overall upload progress for multiple files
  - [ ] Add pause/resume functionality for uploads
  - [ ] Add cancel upload functionality
  - [ ] Handle upload errors gracefully
  - [ ] Store incomplete uploads for resume
- [ ] Create file service layer (AC: All)
  - [ ] Create lib/services/files.service.ts
  - [ ] Implement upload method with progress tracking
  - [ ] Add resumable upload support using TUS protocol
...
- [ ] Update Zustand store for file state (AC: All)
  - [ ] Add file-related state to useAppStore
  - [ ] Implement actions for file operations
  - [ ] Add upload queue management
  - [ ] Track upload progress in state
- [ ] Integrate file upload into dashboard (AC: 1)
  - [ ] Add upload zone to dashboard page
  - [ ] Show recently uploaded files
  - [ ] Add empty state for users with no files
  - [ ] Link uploads to selected course if applicable
  - [ ] Display storage usage indicators
  - [ ] Show upload statistics
- [ ] Write unit tests for file functionality (Testing requirement)
  - [ ] Test file validation utilities
  - [ ] Test file upload API endpoint
  - [ ] Test FileUpload component interactions
  - [ ] Test upload progress tracking
  - [ ] Mock Supabase Storage for tests
- [ ] Implement resumable uploads (AC: 4, 5)
  - [ ] Integrate TUS protocol client
  - [ ] Configure Supabase Storage for resumable uploads
  - [ ] Store upload session metadata
  - [ ] Implement upload recovery on page refresh
  - [ ] Add retry logic with exponential backoff
- [ ] Add client-side image optimization (AC: 8)
  - [ ] Create lib/utils/image-optimizer.ts
  - [ ] Implement HEIC to JPEG conversion
  - [ ] Add image compression using Canvas API
  - [ ] Generate thumbnails for preview
  - [ ] Strip EXIF data for privacy
  - [ ] Detect and flag non-academic images
- [ ] Implement duplicate detection system (AC: 9)
  - [ ] Calculate SHA-256 hash before upload
  - [ ] Create API endpoint to check existing hashes
  - [ ] Show duplicate warning with link to existing file
  - [ ] Allow user to link instead of re-upload
  - [ ] Track space saved from deduplication
- [ ] Add upload analytics (AC: 10)
  - [ ] Create upload_analytics table
  - [ ] Track success/failure rates by file type
  - [ ] Monitor upload speeds by region
  - [ ] Log failed upload reasons
  - [ ] Create dashboard for upload metrics
- [ ] Implement mobile optimizations (AC: 11)
  - [ ] Add camera roll integration
  - [ ] Implement document scanner mode
  - [ ] Add quality reduction options for cellular
  - [ ] Create service worker for background uploads
  - [ ] Optimize UI for touch interactions
- [ ] Set up batch processing queue (AC: 3)
  - [ ] Create upload queue in Zustand store
  - [ ] Implement queue processor service
  - [ ] Add priority handling for smaller files
  - [ ] Handle concurrent upload limits
  - [ ] Queue AI processing tasks post-upload
- [ ] Add academic content detection (AC: 8)
  - [ ] Create lib/utils/academic-detector.ts
  - [ ] Implement image content analysis
  - [ ] Flag potential non-academic content
  - [ ] Add monthly image upload limits
  - [ ] Show warnings for excessive image uploads
