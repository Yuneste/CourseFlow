...
const COUNTRIES = {
  US: { name: 'United States', flag: '🇺🇸', system: 'Semester system' },
  CA: { name: 'Canada', flag: '🇨🇦', system: 'Semester system' },
  UK: { name: 'United Kingdom', flag: '🇬🇧', system: 'Term system' },
  DE: { name: 'Germany', flag: '🇩🇪', system: 'Semester system' },
  NL: { name: 'Netherlands', flag: '🇳🇱', system: 'Block/Period system' },
}
