...
const StatsCard = ({ title, value, icon: Icon, delay = 0, trend, color }: StatsCardProps) => (
  ...
  >
    <Card className="p-6 bg-card border-border shadow-sm hover:shadow-lg transition-all duration-300 relative overflow-hidden shadow-[0_4px_12px_rgba(255,255,255,0.1)]">
    ...
    >
      <Card 
        className={cn(
          ...
          "border-border bg-card shadow-md shadow-[0_4px_12px_rgba(255,255,255,0.1)]",
          available 
