...
const StatsCard = ({ title, value, icon: Icon, delay = 0, trend, color }: StatsCardProps) => (
  ...
  >
    <Card className="p-6 bg-card border border-border shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:shadow-[0_2px_8px_rgba(255,255,255,0.05)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.12)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.08)] transition-all duration-300 relative overflow-hidden">
    ...
    >
      <Card 
        className={cn(
          ...
          "border border-border bg-card shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:shadow-[0_2px_8px_rgba(255,255,255,0.05)]",
          available 
