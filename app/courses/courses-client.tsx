        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCourses.map((course, index) => (
            ...
            >
              ...
              >
              <Card className={cn(
                "h-[250px] transition-all duration-300 bg-card backdrop-blur-sm border border-border cursor-move shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:shadow-[0_2px_8px_rgba(255,255,255,0.05)] hover:shadow-[0_8px_16px_rgba(0,0,0,0.12)] dark:hover:shadow-[0_8px_16px_rgba(255,255,255,0.08)] flex flex-col",
